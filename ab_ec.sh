...
VARIANTS="${VARIANTS:-CUDACyclone CUDACyclone-rckfield CUDACyclone-rckinv CUDACyclone-rckall}"
...
echo "OK: $(ls -1 CUDACyclone CUDACyclone-rck* CUDACyclone-ecbench 2>/dev/null | tr '\n' ' ')"
