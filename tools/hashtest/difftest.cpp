...
#ifdef HAVE_HASH2_X2
// Only defined where the tree has a 2-wide entry point; extract2.py reports how many call sites
// each side actually has, so a tree with none simply never reaches this.
